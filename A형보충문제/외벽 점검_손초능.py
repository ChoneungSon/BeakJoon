...
print(solution1(12, [1, 5, 6, 10], [1, 2, 3, 4]))
# 4, 1, 4, 3
print(solution1(12, [1, 3, 4, 9, 10], [3, 5, 7]))
# 2, 1, 5, 1, 3
print(solution1(20, [1, 10], [2, 9]))
print(solution1(25, [1, 6, 10, 13, 16, 19], [1, 1, 8]))
# 5, 4, 3, 3, 3, 6
print(solution1(2, [0, 1], [1, 1, 1, 1, 1]))
print(solution1(50, [1, 5, 10, 16, 22, 25], [3, 4, 6]))
# 4 5 6 6 3 26